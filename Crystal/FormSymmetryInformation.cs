...
public partial class FormSymmetryInformation : FormBase
{
    ...
    private void LocalizeLabels()
    {
        ...
        label40.Text = Loc(en: "The axis normal to both planes", ja: "両面に垂直な軸", de: "Achse senkrecht zu beiden Ebenen", fr: "L'axe normal aux deux plans", es: "Eje normal a ambos planos", pt: "O eixo normal a ambos os planos", it: "L'asse normale a entrambi i piani", ru: "Ось ⊥ обеим плоскостям", zhHans: "同时垂直于两晶面的晶轴", zhHant: "垂直於兩晶面的晶軸", ko: "두 면에 수직인 축");
        label42.Text = Loc(en: "The plane normal to both axes", ja: "両軸に垂直な面", de: "Ebene senkrecht zu beiden Achsen", fr: "Le plan normal aux deux axes", es: "Plano normal a ambos ejes", pt: "O plano normal a ambos os eixos", it: "Il piano normale a entrambi gli assi", ru: "Плоскость ⊥ обеим осям", zhHans: "同时垂直于两晶轴的晶面", zhHant: "垂直於兩晶軸的晶面", ko: "두 축에 수직인 면");
        ...
        label5.Text = Loc(en: "HM symbol (short):", ja: "HM 記号 (短縮):", de: "HM-Symbol (kurz):", fr: "Symbole HM (court) :", es: "Símbolo HM (corto):", pt: "Símbolo HM (curto):", it: "Simbolo HM (corto):", ru: "HM (краткий):", zhHans: "HM 符号(简):", zhHant: "HM 符號（簡式）：", ko: "HM 기호 (단축형):");
        label6.Text = Loc(en: "HM symbol (full):", ja: "HM 記号 (完全):", de: "HM-Symbol (voll):", fr: "HM (complet) :", es: "HM (completo):", pt: "HM (completo):", it: "HM (completo):", ru: "HM (полный):", zhHans: "HM 符号(全):", zhHant: "HM 符號（全式）：", ko: "HM 기호 (완전형):");
        label.Text = Loc(en: "Crystal System:", ja: "結晶系:", de: "Kristallsystem:", fr: "Système cristallin :", es: "Sistema cristalino:", pt: "Sistema cristalino:", it: "Sistema cristallino:", ru: "Крист. система:", zhHans: "晶系:", zhHant: "晶系：", ko: "결정계:");
