...
public partial class HorizontalAxisUserControl : UserControlBase
{
    ...
    public TimeUnitEnum TofTimeUnit
    {
        set
        {
            if (value == TofTimeUnit) return;
            if (value != TimeUnitEnum.NanoSecond && value != TimeUnitEnum.MicroSecond) return;
        ...
        get
        {
            if (radioButtonTofUnitNanoSec.Checked)
                return TimeUnitEnum.NanoSecond;
            else
                return TimeUnitEnum.MicroSecond;
        }
    }
    ...
    public string TofAngleText
    {
        ...
        get => numericBoxTofAngle.Value.ToString();
    }
